...
module.exports = async (client) => {
    ...
    client.on('message', async msg => {
        ...
        else if(msg.content.startsWith('<@777872323469377566>')) text = msg.content.substring(21)
        else if(msg.content.startsWith('<@!777872323469377566>')) text = msg.content.substring(22)
        else return
        text = text.trim()
